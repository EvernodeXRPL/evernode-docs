...
- Proposal for a New Hook Candidate (All three hooks will be affected).
  - The Participant can submit a Proposal with new Hook hashes of above mentioned 4 Hooks. Once that Proposal is continuously supported by 66% of eligible Participants for 5 days, the existing hooks will be replaced by the proposed hooks.
...
- A Proposal succeeds if it is continuously Supported by more than 66% of [eligible participants](#voting) for 5 days.
