...
## Host Reputation
- **Reputation Management:** Host reputation is dynamically adjusts based on specified guidelines, ensuring fairness and reliability within the Evernode network.
...
- **Your reputation will be set to 0 based on:**
  ...
  - Sanctioned Entities
    - Once version 0.8.2 is rolled out, You won't be able to update your host or install a new host if your machine is from on of the **Sanctioned Entities** mentioned in [Evernode license](https://raw.githubusercontent.com/EvernodeXRPL/evernode-test-resources/main/license/evernode-license.pdf)
  - Lease Amount
